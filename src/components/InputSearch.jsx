...
export function InputSearch ({ buscarPlace }) {
  ...
  return (
    <header className='bg-base-color'>
      ...
      <nav className={`${abrirMenu ? 'fixed' : 'hidden'} top-0 left-0 right-0 bottom-0 md:w-[400px] bg-base-color text-center items-center justify-center z-50 overflow-auto no-scrollbar p-3`}>
        <button
